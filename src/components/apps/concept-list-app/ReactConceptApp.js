...
export default class ReactConceptsApp extends Component {
  ...
  toggleConcept(concepts) {
    let concept = _.find(this.state.concpets, concepts);
    ...
    return (
      <div className="main">
        <div className="maindiv">
          ...
          <p>
            Use the list below to toggle concepts that you do or do not
            understand. Note that this will updte when you refresh the page.
          </p>
          <h2>General Concepts</h2>
          <ConceptList
            concepts={this.state.concepts}
            toggle={this.toggleConcept.bind(this)}
          />
